        ...
        if ($row["email"] == $email_id && $row["password"] == $psw_log) {
            ...
            <nav class="govblue">
                <ul class="side">
                    ...
                    <li><a href="index.php">Asset Request and Management System</a></li>
                    <li><a href="office_index.php">Employee</a></li>
                    <li><a href="login.php?action=logout">Logout</a></li>
                </ul>
                <ul>
                    <li><a href="index.php"><img src="images/logocity.webp" alt="GovLogo" style="width:50px; margin:5px; margin-right:15px;"><span class="hideOnMobile">Asset Request and Management System</span></a></li>
                    <li class="hideOnMobile"><a href="office_index.php">Employee</a></li>
