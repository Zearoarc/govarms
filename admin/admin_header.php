...
<body>
  <nav class="govblue">
    <ul class="side">
      ...
      <li><a href="admin_manageusers.php">Admin Asset Request and Reservation System</a></li>
      <li><a href="../login.php?action=logout">Logout</a></li>
    </ul>
    <ul>
      <li><a href="admin_manageusers.php"><img src="..//images/logocity.webp" alt="GovLogo" style="width:50px; margin:5px; margin-right:15px;"><span class="hideOnMobile">Admin Asset Request and Reservation System</span></a></li>
