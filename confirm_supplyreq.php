...
<head>
    ...
    <title>Confirm Supply Request</title>
...
<body>
    <div class="container">
        <h1>Confirm Supply Request (<?php while ($row = $result->fetch_assoc()) {
                echo $row["name"];
            }  ?>)</h1>
        <form action="process_supplyreq.php?assets=<?php echo $encodedAssets; ?>" method="post">
